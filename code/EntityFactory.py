...
class EntityFactory:
    ...
    def get_entity(entity_name: str):
        match entity_name:
            ...
            case 'Level3Bg': # 5- O level 3 deve ter um background diferente do level 1 e level 2. Assim como nos outros levels, o background deve funcionar com efeito de parallax.
                list_bg = []
